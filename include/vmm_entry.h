...
#define VMM_ERROR_INVALID_FACTORY ((void *)-4)
#define VMM_ERROR_DEBUG_RING_INIT_FAILED ((void *)-10)
#define VMM_ERROR_MEMORY_MANAGER_INIT_FAILED ((void *)-11)
#define VMM_ERROR_VMM_INIT_FAILED ((void *)-12)
